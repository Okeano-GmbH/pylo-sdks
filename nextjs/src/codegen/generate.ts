...
export function generateIndexFile(entities: AnalyzedEntity[]): string {
  const lines: string[] = [];

  lines.push(
    "// Auto-generated by @pylo/nextjs codegen — DO NOT EDIT",
    "",
    "export type {",
    "  FilterInput,",
    "  PaginationData,",
...
export function generateEntitiesFile(entities: AnalyzedEntity[]): string {
  const lines: string[] = [];

  lines.push(
    "// Auto-generated by @pylo/nextjs codegen — DO NOT EDIT",
    "",
    "import type { PaginationData } from '@pylo/nextjs';",
    "",
  );
...
export function generateSchemaMetadataFile(
  ...
  lines.push(
    "// Auto-generated by @pylo/nextjs codegen — DO NOT EDIT",
    "",
    "import type { SchemaMetadata } from '@pylo/nextjs';",
    "",
